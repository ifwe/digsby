...
!define MUI_FINISHPAGE_V_OFFSET 0
...
!macro MUI_PAGE_WELCOME
  ...
  #!insertmacro MUI_UNSET MUI_WELCOMEPAGE_IMAGE
...
!macro MUI_PAGE_FINISH
  ...
  !insertmacro MUI_DEFAULT_IOCONVERT MUI_FINISHPAGE_CHECKBOX3_TEXT "$(MUI_TEXT_FINISH_CHECKBOX3)"
  !insertmacro MUI_DEFAULT_IOCONVERT MUI_FINISHPAGE_CHECKBOX4_TEXT "$(MUI_TEXT_FINISH_CHECKBOX4)"
  !insertmacro MUI_DEFAULT_IOCONVERT MUI_FINISHPAGE_CHECKBOX5_TEXT "$(MUI_TEXT_FINISH_CHECKBOX5)"
  !insertmacro MUI_DEFAULT_IOCONVERT MUI_FINISHPAGE_CHECKBOX6_TEXT "$(MUI_TEXT_FINISH_CHECKBOX6)"
  ...
  !define FINISH_PRE_FUNCNAME ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.FinishPre_${MUI_UNIQUEID}
  !define FINISH_LEAVE_FUNCNAME ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}mui.FinishLeave_${MUI_UNIQUEID}

  PageEx ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}custom

    PageCallbacks "${FINISH_PRE_FUNCNAME}" "${FINISH_LEAVE_FUNCNAME}"

    Caption " "

  PageExEnd

  !insertmacro MUI_FUNCTION_FINISHPAGE "${FINISH_PRE_FUNCNAME}" "${FINISH_LEAVE_FUNCNAME}"
  ...
  !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX3
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX3_TEXT
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX3_NOTCHECKED
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX3_FUNCTION
  !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX4
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX4_TEXT
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX4_NOTCHECKED
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX4_FUNCTION
  !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX5
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX5_TEXT
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX5_NOTCHECKED
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX5_FUNCTION
  !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX6
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX6_TEXT
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX6_NOTCHECKED
    !insertmacro MUI_UNSET MUI_FINISHPAGE_CHECKBOX6_FUNCTION
  !insertmacro MUI_UNSET MUI_FINISHPAGE_LINK
    !insertmacro MUI_UNSET MUI_FINISHPAGE_LINK_LOCATION
    !insertmacro MUI_UNSET MUI_FINISHPAGE_LINK_FUNCTION
...
!macro MUI_FUNCTION_WELCOMEPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !ifdef MUI_WELCOMEPAGE_IMAGE
      !ifdef MUI_WELCOMEPAGE_LINK
        !define MUI_WELCOME_PAGE_NUMFIELDS 5
        !define MUI_WELCOMEPAGE_LINKFIELD 5
      !else
        !define MUI_WELCOME_PAGE_NUMFIELDS 4
      !endif
    !else
      !ifdef MUI_WELCOMEPAGE_LINK
        !define MUI_WELCOMEPAGE_LINKFIELD 4
        !define MUI_WELCOME_PAGE_NUMFIELDS 4
      !else
        !define MUI_WELCOME_PAGE_NUMFIELDS 3
      !endif
    !endif

    !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "NumFields" "${MUI_WELCOME_PAGE_NUMFIELDS}"
    !undef MUI_WELCOME_PAGE_NUMFIELDS
    ...
    !ifdef MUI_WELCOMEPAGE_IMAGE
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Type" "Bitmap"
      File "/oname=$PLUGINSDIR\welcome_image.bmp" "${MUI_WELCOMEPAGE_IMAGE_FILENAME}"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Text" "$PLUGINSDIR\welcome_image.bmp"
      !ifdef MUI_WELCOMEPAGE_IMAGE_NOSTRETCH
        !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Flags" ""
      !endif
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "${MUI_WELCOMEPAGE_IMAGE_TOP}"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "${MUI_WELCOMEPAGE_IMAGE_BOTTOM}"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Left" "${MUI_WELCOMEPAGE_IMAGE_LEFT}"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Right" "${MUI_WELCOMEPAGE_IMAGE_RIGHT}"
    !endif
    
    !ifdef MUI_WELCOMEPAGE_LINK
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Type" "Link"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Text" MUI_WELCOMEPAGE_LINK_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Top" "100"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Bottom" "110"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Left" "120"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_WELCOMEPAGE_LINKFIELD}" "State" "${MUI_WELCOMEPAGE_LINK}"
      !undef MUI_WELCOMEPAGE_LINKFIELD
    !endif
  ...
  Function "${LEAVE}"
    ...
    !ifdef MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_WELCOME_CUSTOMLEAVE_FUNC
...
!macro MUI_FUNCTION_LICENSEPAGE PRE SHOW LEAVE
  ...
  Function "${LEAVE}"
    ...
    !insertmacro MUI_PAGE_FUNCTION_CUSTOM LEAVE
    !ifdef MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_LICENSE_CUSTOMLEAVE_FUNC
      Call "${MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_LICENSE_CUSTOMLEAVE_FUNC}"
    !endif
...
!macro MUI_FUNCTION_DIRECTORYPAGE PRE SHOW LEAVE
  ...
  Function "${LEAVE}"
    !insertmacro MUI_PAGE_FUNCTION_CUSTOM LEAVE
    !ifdef MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_DIRECTORY_CUSTOMLEAVE_FUNC
      Call "${MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_DIRECTORY_CUSTOMLEAVE_FUNC}"
    !endif
  FunctionEnd
...
!macro MUI_FUNCTION_INSTFILESPAGE PRE SHOW LEAVE
  ...
  Function "${LEAVE}"
    ...
    !ifdef MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_INSTALL_CUSTOMLEAVE_FUNC
...
!macro MUI_FUNCTION_FINISHPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !ifdef MUI_FINISHPAGE_CURFIELD_TOP
        !undef MUI_FINISHPAGE_CURFIELD_TOP
    !endif
    !ifdef MUI_FINISHPAGE_CURFIELD_BOTTOM
        !undef MUI_FINISHPAGE_CURFIELD_BOTTOM
    !endif

    !ifndef MUI_FINISHPAGE_TITLE_3LINES
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "38"
      !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_V_OFFSET} + 45
    !else
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 2" "Bottom" "48"
      !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_V_OFFSET} + 55
    !endif
    ...
    !ifdef MUI_FINISHPAGE_RUN | MUI_FINISHPAGE_SHOWREADME
      !ifndef MUI_FINISHPAGE_TITLE_3LINES
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_V_OFFSET} + 85
        !else
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_V_OFFSET} + 115
        !endif
      !else
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_V_OFFSET} + 95
        !else
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_V_OFFSET} + 125
        !endif
      !endif
    !else
      ...
      !else
        !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_V_OFFSET} + 175
      !endif
    !endif

    !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
    !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
    ...
    !ifdef MUI_FINISHPAGE_RUN
      ...
      !ifndef MUI_FINISHPAGE_TITLE_3LINES
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_RUN_VOFFSET} + 0
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_RUN_VOFFSET} + 10
        !else
          !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_RUN_VOFFSET} + 20
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_RUN_VOFFSET} + 30
        !endif
      !else
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_RUN_VOFFSET} + 0
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_RUN_VOFFSET} + 10
        !else
          !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_RUN_VOFFSET} + 30
          !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_RUN_VOFFSET} + 40
        !endif
      !endif
    ...
    !ifdef MUI_FINISHPAGE_SHOWREADME
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 30
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 40
          !endif
        !endif
      !else
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 30
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 40
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 50
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 40
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 50
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_SHOWREADME_VOFFSET} + 60
          !endif
        !endif
      !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX3
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 30
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 40
          !endif
        !endif
      !else
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 30
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 40
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 50
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 40
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 50
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX3_VOFFSET} + 60
          !endif
        !endif
      !endif

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "CheckBox"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_CHECKBOX3_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "120"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX4
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 30
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 40
          !endif
        !endif
      !else
        !define MUI_FINISHPAGE_CURFIELD_NO 7
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 30
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 40
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 50
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 40
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 50
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX4_VOFFSET} + 60
          !endif
        !endif
      !endif

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "CheckBox"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_CHECKBOX4_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "120"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX5
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 30
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 40
          !endif
        !endif
      !else
        !define MUI_FINISHPAGE_CURFIELD_NO 8
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 30
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 40
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 50
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 40
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 50
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX5_VOFFSET} + 60
          !endif
        !endif
      !endif

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "CheckBox"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_CHECKBOX5_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "120"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
      !ifndef MUI_FINISHPAGE_CHECKBOX5_NOTCHECKED
         !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "State" "1"
      !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX6
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 30
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 10
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 20
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 40
          !endif
        !endif
      !else
        !define MUI_FINISHPAGE_CURFIELD_NO 9
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 20
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 30
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 40
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 50
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 30
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 40
          !else
            !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 50
            !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_CHECKBOX6_VOFFSET} + 60
          !endif
        !endif
      !endif

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "CheckBox"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_CHECKBOX6_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "120"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
      !ifndef MUI_FINISHPAGE_CHECKBOX6_NOTCHECKED
         !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "State" "1"
      !endif
    ...
    !ifdef MUI_FINISHPAGE_LINK
      ...
      !ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_CHECKBOX6
        !define MUI_FINISHPAGE_CURFIELD_NO 10
      !else ifdef MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_CHECKBOX6
        !define MUI_FINISHPAGE_CURFIELD_NO 9
      !else ifdef MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5
        !define MUI_FINISHPAGE_CURFIELD_NO 8
      ...
      !else
        !define MUI_FINISHPAGE_CURFIELD_NO 4
      !endif
      !define /math MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_LINK_VOFFSET} + 20
      !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_LINK_VOFFSET} + 30

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "Link"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_LINK_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "132"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "315"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
      ...
      !else ifdef MUI_FINISHPAGE_LINK_FUNCTION
          !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Flags" "NOTIFY"
          !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Notify" "ONCLICK"
          ;!insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "ExtraData" "${MUI_FINISHPAGE_LINK_FUNCTION}"
      !endif

      StrCpy $MUI_LINK_ID "${MUI_FINISHPAGE_CURFIELD_NO}"
    ...
    !ifdef MUI_FINISHPAGE_GROUPCHECKS
      !ifdef MUI_FINISHPAGE_CURFIELD_NO
        !undef MUI_FINISHPAGE_CURFIELD_NO
      !endif

      !ifdef      MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_LINK & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_CHECKBOX6 & MUI_FINISHPAGE_GROUPCHECKS
        !define MUI_FINISHPAGE_CURFIELD_NO 12
      !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_LINK & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_GROUPCHECKS
        !define MUI_FINISHPAGE_CURFIELD_NO 11
      !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_CHECKBOX6 & MUI_FINISHPAGE_LINK
        !define MUI_FINISHPAGE_CURFIELD_NO 11
      !else ifdef MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_LINK & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_GROUPCHECKS
        !define MUI_FINISHPAGE_CURFIELD_NO 10
      !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_CHECKBOX6
        !define MUI_FINISHPAGE_CURFIELD_NO 10
      !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5
        !define MUI_FINISHPAGE_CURFIELD_NO 9
      !else ifdef MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5 & MUI_FINISHPAGE_SHOWREADME
        !define MUI_FINISHPAGE_CURFIELD_NO 8
      !endif
      
      !define MUI_FINISHPAGE_CURFIELD_TOP ${MUI_FINISHPAGE_GROUPCHECKS_VOFFSET}
      !define /math MUI_FINISHPAGE_CURFIELD_BOTTOM ${MUI_FINISHPAGE_GROUPCHECKS_VOFFSET} + ${MUI_FINISHPAGE_GROUPCHECKS_VSIZE}

      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Type" "GroupBox"
      !insertmacro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Text" MUI_FINISHPAGE_GROUPCHECKS_TEXT
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "FontBold" "1"
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Left" "116"  # was 120
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Right" "325" # was 315
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Top" ${MUI_FINISHPAGE_CURFIELD_TOP}
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field ${MUI_FINISHPAGE_CURFIELD_NO}" "Bottom" ${MUI_FINISHPAGE_CURFIELD_BOTTOM}
    ...
    !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "Numfields" "${MUI_FINISHPAGE_CURFIELD_NO}"
    ...
    GetDlgItem $MUI_TEMP1 $MUI_HWND 1206
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"

    GetDlgItem $MUI_TEMP1 $MUI_HWND 1207
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"

    GetDlgItem $MUI_TEMP1 $MUI_HWND 1208
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"

    GetDlgItem $MUI_TEMP1 $MUI_HWND 1209
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
    
    GetDlgItem $MUI_TEMP1 $MUI_HWND 1210
    SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX3
      ...
      !endif
      SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
      !ifdef MUI_FINISHPAGE_CHECKBOX3_STARTHIDDEN
        ShowWindow $MUI_TEMP1 ${SW_HIDE}
      !endif
    !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX4
      ...
      !endif
      SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
      !ifdef MUI_FINISHPAGE_CHECKBOX4_STARTHIDDEN
        ShowWindow $MUI_TEMP1 ${SW_HIDE}
      !endif
    !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX5
      ...
      !endif
      SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
      !ifdef MUI_FINISHPAGE_CHECKBOX5_STARTHIDDEN
        ShowWindow $MUI_TEMP1 ${SW_HIDE}
      !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX6
      ...
      !endif
      SetCtlColors $MUI_TEMP1 "" "${MUI_BGCOLOR}"
      !ifdef MUI_FINISHPAGE_CHECKBOX6_STARTHIDDEN
        ShowWindow $MUI_TEMP1 ${SW_HIDE}
      !endif
    ...
    !ifdef MUI_FINISHPAGE_GROUPCHECKS
      ...
      SendMessage $MUI_TEMP1 ${WM_SETFONT} $1 1
    !endif
    !ifndef MUI_FINISHPAGE_NOREBOOTSUPPORT
      mui.finish_show:
    !endif
    ...
    !ifdef FINISHPAGE_CUSTOM_SHOW_FUNCTION
        Call "${FINISHPAGE_CUSTOM_SHOW_FUNCTION}"
    !endif
  ...
  Function "${LEAVE}"
    ...
    !ifdef MUI_FINISHPAGE_LINK
        !ifdef MUI_FINISHPAGE_LINK_FUNCTION
            !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Settings" "State"
            !insertmacro INSTALLOPTIONS_READ $MUI_TEMP2 "ioSpecial.ini" "Field $MUI_TEMP1" "Text"

            StrCmp $MUI_TEMP1 $MUI_LINK_ID 0 mui.not_link_clicked
                Call "${MUI_FINISHPAGE_LINK_FUNCTION}"
                Abort "Showing links"
            mui.not_link_clicked:
        !endif
    !endif
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX3
      ...
      !ifndef MUI_FINISHPAGE_RUN
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 5" "State"
      !else
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 6" "State"
      !endif

      StrCmp $MUI_TEMP1 "1" 0 mui.finish_nocheckbox3
        !ifndef MUI_FINISHPAGE_CHECKBOX3_FUNCTION
           ExecShell "open" "${MUI_FINISHPAGE_CHECKBOX3}"
        !else
          Call "${MUI_FINISHPAGE_CHECKBOX3_FUNCTION}"
        !endif

        mui.finish_nocheckbox3:
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX4
      ...
      !ifndef MUI_FINISHPAGE_RUN
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 6" "State"
      !else
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 7" "State"
      !endif

      StrCmp $MUI_TEMP1 "1" 0 mui.finish_nocheckbox4
        !ifndef MUI_FINISHPAGE_CHECKBOX4_FUNCTION
           ExecShell "open" "${MUI_FINISHPAGE_CHECKBOX4}"
        !else
          Call "${MUI_FINISHPAGE_CHECKBOX4_FUNCTION}"
        !endif

        mui.finish_nocheckbox4:
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX5
      ...
      !ifndef MUI_FINISHPAGE_RUN
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 7" "State"
      !else
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 8" "State"
      !endif

      StrCmp $MUI_TEMP1 "1" 0 mui.finish_nocheckbox5
        !ifndef MUI_FINISHPAGE_CHECKBOX5_FUNCTION
           ExecShell "open" "${MUI_FINISHPAGE_CHECKBOX5}"
        !else
          Call "${MUI_FINISHPAGE_CHECKBOX5_FUNCTION}"
        !endif

        mui.finish_nocheckbox5:
    ...
    !ifdef MUI_FINISHPAGE_CHECKBOX6
      ...
      !ifndef MUI_FINISHPAGE_RUN
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 8" "State"
      !else
        !insertmacro INSTALLOPTIONS_READ $MUI_TEMP1 "ioSpecial.ini" "Field 9" "State"
      !endif

      StrCmp $MUI_TEMP1 "1" 0 mui.finish_nocheckbox6
        !ifndef MUI_FINISHPAGE_CHECKBOX6_FUNCTION
           ExecShell "open" "${MUI_FINISHPAGE_CHECKBOX6}"
        !else
          Call "${MUI_FINISHPAGE_CHECKBOX6_FUNCTION}"
        !endif

        mui.finish_nocheckbox6:

    !endif
    !ifdef MUI_${MUI_PAGE_UNINSTALLER_PREFIX}PAGE_FINISH_CUSTOMLEAVE_FUNC
...
!macro MUI_DEFAULTCONVERT SYMBOL
    Push "${${SYMBOL}}"
    Call ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}Nsis2Io
!macroend
;--------------------------------
