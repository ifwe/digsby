...
!macro MUI_FUNCTION_FINISHPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !ifdef MUI_FINISHPAGE_RUN
      ...
      !ifndef MUI_FINISHPAGE_TITLE_3LINES
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "150"
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "160"
        !else
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "170"
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "180"
        !endif
      !else
        !ifndef MUI_FINISHPAGE_TEXT_LARGE
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "150"
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "160"
        !else
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Top" "180"
          !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Bottom" "190"
        !endif
      !endif
      ...
      !ifndef MUI_FINISHPAGE_RUN
        ...
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 150
          !else
            !define MUI_FINISHPAGE_CURFIELD_TOP 170
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 180
          !endif
        !endif
      !else
        ...
        !ifndef MUI_FINISHPAGE_TITLE_3LINES
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 170
          !else
            !define MUI_FINISHPAGE_CURFIELD_TOP 180
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 190
          !endif
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            !define MUI_FINISHPAGE_CURFIELD_TOP 170
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 180
          !else
            !define MUI_FINISHPAGE_CURFIELD_TOP 190
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 200
          !endif
        !endif
      !endif
      ...
      !else
        ...
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 190
          !else
            !define MUI_FINISHPAGE_CURFIELD_TOP 200
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 210
          !endif
        !endif
      !endif
      ...
      !else
        ...
        !else
          !ifndef MUI_FINISHPAGE_TEXT_LARGE
            ...
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 200
          !else
            !define MUI_FINISHPAGE_CURFIELD_TOP 210
            !define MUI_FINISHPAGE_CURFIELD_BOTTOM 220
          !endif
        !endif
      !endif
    ...
    !ifdef MUI_FINISHPAGE_LINK
      ...
      !ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5
    ...
    !ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_LINK & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "Numfields" "9"
    !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME & MUI_FINISHPAGE_CHECKBOX3 & MUI_FINISHPAGE_CHECKBOX4 & MUI_FINISHPAGE_CHECKBOX5
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "Numfields" "8"
    !else ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME
      !insertmacro INSTALLOPTIONS_WRITE "ioSpecial.ini" "Settings" "Numfields" "5"
